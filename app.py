        ...
        if menu_items:
            ...
            for i in range(0, len(menu_items), 2):
                ...
                if i + 1 < len(menu_items):
                    ...
                    forTo correctly parse the provided menu items and ingredients, we need to account for cases where cocktail names and ingredients are on separate lines. Here's an adjusted version of the Streamlit app to handle these scenarios.
